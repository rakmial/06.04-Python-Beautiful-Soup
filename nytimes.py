...
API_KEY = { "popular": "6f114aedc2ed43a08c958d20afc385eb",
            "article": "6f114aedc2ed43a08c958d20afc385eb"}

### KIND = [VIEWED, SHARED, EMAILED]
...
def article_overview(kind, period):
    ...
    for entry in data:
        ...
        for medium in entry["media"]:
            for datum in medium["media-metadata"]:
                if datum["format"] == "Standard Thumbnail":
